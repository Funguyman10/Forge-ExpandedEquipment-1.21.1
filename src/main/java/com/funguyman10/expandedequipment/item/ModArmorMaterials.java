...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> COPPER_ARMOR_MATERIAL = register("copper",
            ...
            }), 20, 1f, 0.0f, () -> Items.COPPER_INGOT);

    public static final Holder<ArmorMaterial> CHORUNDUM_ARMOR_MATERIAL = register("chorundum",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 15, 4f, 0.1f, () -> Items.COPPER_INGOT);


    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(ExpandedEquipment.MOD_ID, name);
