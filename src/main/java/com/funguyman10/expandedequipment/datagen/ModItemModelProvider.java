...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, ExpandedEquipment.MOD_ID, existingFileHelper);
    }

    @Override
    protected void registerModels() {
        basicItem(ModItems.RAW_CHORUNDUM.get());
        basicItem(ModItems.CHORUNDUM.get());
        basicItem(ModItems.ENERGETIC_ROCK.get());
        basicItem(ModItems.CHORUNDUM_UPGRADE_TEMPLATE.get());
        ...
        handheldItem(ModItems.CHORUNDUM_SHOVEL);
        ...
        trimmedArmorItem(ModItems.CHORUNDUM_LEGGINGS);
        trimmedArmorItem(ModItems.CHORUNDUM_BOOTS);
    ...
    private ItemModelBuilder handheldItem(RegistryObject<?> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(ExpandedEquipment.MOD_ID, "item/" + item.getId().getPath()));
    }

    // Shoutout to El_Redstoniano for making this
    private void trimmedArmorItem(RegistryObject<ArmorItem> itemRegistryObject) {
        final String MOD_ID = ExpandedEquipment.MOD_ID; // Change this to your mod id
